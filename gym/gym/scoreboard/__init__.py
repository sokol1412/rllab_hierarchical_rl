...
from gym.gym.scoreboard.client.resource import Algorithm, BenchmarkRun, Evaluation, FileUpload
from gym.gym.scoreboard.registration import registry, add_task, add_group, add_benchmark
