...
from sandbox.ex2.utils.distributions import log_stdnormal, log_normal2, log_bernoulli, kl_normal2_stdnormal
import numpy as np
from sandbox.ex2.utils.theano_utils import compile_timer
...
def test2d(train_itrs=5000, batch_size=128):
    ...
    def generate_2d_test_data(N):
        ...
        return negatives
    import os
    from sandbox.ex2.envs.twod_mjc_env import map_config, get_dense_gridpoints, predictions_to_heatmap, make_density_map
