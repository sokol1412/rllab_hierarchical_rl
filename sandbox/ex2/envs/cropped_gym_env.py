...
try:
    import logging
    from gym.gym.gymwrappers.monitoring import logger as monitor_logger
...
class CroppedGymEnv(GymEnv):
    def __init__(self, env_name, register_info=None, record_video=True, video_schedule=None, log_dir=None, record_log=True,
        ...
        if 'Doom' in env_name:
            from sandbox.ex2.envs.doom.wrappers import SetResolution
            from sandbox.ex2.envs.doom.wrappers.action_space import ToDiscrete, ToBox
